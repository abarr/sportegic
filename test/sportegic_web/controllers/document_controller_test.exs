defmodule SportegicWeb.DocumentControllerTest do
  use SportegicWeb.ConnCase

  alias Sportegic.People

  @create_attrs %{additional_info: "some additional_info", expiry_date: ~D[2010-04-17], file: "some file", issuer: "some issuer", number: "some number"}
  ...
  def fixture(:document) do
    {:ok, document} = People.create_document(@create_attrs)
    document
  end
