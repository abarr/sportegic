defmodule SportegicWeb.AddressController do
  ...
  def new(conn, _params, person, org, permissions) do
    with :ok <- Bodyguard.permit(People, "create:address_permissions", "", permissions) do
  ...
  def create(conn, %{"address" => address_params}, person, org, permissions) do
    with :ok <- Bodyguard.permit(People, "create:address_permissions", "", permissions) do
      address_params =
        address_params
  ...
  def edit(conn, %{"id" => id}, person, org, permissions) do
    with :ok <- Bodyguard.permit(People, "edit:address_permissions", "", permissions) do
  ...
  def update(conn, %{"id" => id, "address" => address_params}, person, org, permissions) do
    with :ok <- Bodyguard.permit(People, "edit:address_permissions", "", permissions) do
      address = People.get_address!(person, id, org)
  ...
  def delete(conn, %{"id" => id}, person, org, permissions) do
    with :ok <- Bodyguard.permit(People, "delete:address_permissions", "", permissions) do
      address = People.get_address!(person, id, org)
